...
async function createTables() {
  // create tables is commented out because birdseed now handles the creation of tables
  const initSQL = fs.readFileSync('data.sql').toString();
  await db.query(initSQL);
}

// async function insertCategory(title) {
//   let categoryResult1 = await db.query(`
//     INSERT INTO categories (title)
//     VALUES ('entertainment')
//     RETURNING title
//   `);

//   let categoryResult2 = await db.query(`
//     INSERT INTO categories (title)
//     VALUES ('politics')
//     RETURNING title
//   `);

//   const category1 = categoryResult1.rows[0];
//   const category2 = categoryResult2.rows[0];
// }
...
async function insertTestData() {
  ...
  //   VALUES ('${
  //     user1.username
  //   }', 'best albums of 2009', 'hot fiya', '${category1}')
  ...
  //   VALUES ('${
  //     user2.username
  //   }','top ceos','top ceos of all time', '${category2}')
  //   RETURNING id, author, title, description, anonymous, date_posted, category
  // `);
